  ...
  `;
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.systems = yield this.http.get('https://sheikhalamoud.org/apis/systems/').toPromise();
            this.systems.map(sys => sys.description = sys.description.replace(/(?:\\[rn]|[\r\n]+)+/g, "\n\n").replace(/\\"/g, '"'));
...
let AppComponent = class AppComponent {
    constructor(router, _route, translate, titleService) {
        this.router = router;
        this._route = _route;
        ...
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(e => e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"])).subscribe((e) => {
            this.pathname = location.hash.split('/');
            this.pathname = this.pathname[1].includes('?') ? this.pathname[1].split('?')[0] : this.pathname[1];
            this.activeTab = this.pathname;
            this.setTitle(this.pathname);
            this.tabs = ['', 'about', 'schedules', 'instructors', 'archive', 'albums', 'start-learning', 'FAQs'];
        });
    }
    setTitle(newTitle) {
        newTitle === ''
...
let ArchiveComponent = class ArchiveComponent {
    ...
    getSciences() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.sciences = yield this.http.get('https://sheikhalamoud.org/apis/sciences/').toPromise();
            this.sciences.map((s, i) => {
                s.children = this.sciences.slice(i + 1).map(cs => cs.parent_uid === s.uid);
            });
...
let CourseComponent = class CourseComponent {
    ...
    getCourse() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.course = yield this.http.get(`https://sheikhalamoud.org/apis/sessions/${id}`).toPromise();
...
let FaqsComponent = class FaqsComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.faqs = yield this.http.get('https://sheikhalamoud.org/apis/faqs/').toPromise();
...
let HeaderSvgComponent = class HeaderSvgComponent {
    constructor() { }
    ngOnInit() { }
    ngAfterViewInit() {
        this.title = this.text.split(' ');
        let hw; // elm half width
        let x;
        let halfs;
        let text = this.injtext.nativeElement;
        const allSVG = this.svg.nativeElement.getBoundingClientRect().width;
        const halfSVG = this.svg.nativeElement.getBoundingClientRect().width / 2;
        const SVGBox = this.svg.nativeElement.getBBox().width;
        text.innerHTML += `<text y="46%" style="font-size: 1.2rem;" id="${this.index}processing">${this.title[0]}</text>`;
        setTimeout(() => {
            let processing = document.getElementById(`${this.index}processing`);
            hw = processing.getBoundingClientRect().width / 2;
            halfs = (halfSVG + hw);
            x = halfs * SVGBox / allSVG;
            processing.setAttribute('x', x.toString());
            text.innerHTML += `<text y="58%" id="${this.index}rest">${this.title.slice(1).join(' ')}</text>`;
            setTimeout(() => {
                let rest = document.getElementById(`${this.index}rest`);
...
let InstructorComponent = class InstructorComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const id = location.hash.split('/')[2];
            this.instructor = yield this.http.get(`https://sheikhalamoud.org/apis/instructors/${id}`).toPromise();
...
let InstructorsComponent = class InstructorsComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.instructors = !this.inInstructors
                ? yield this.http.get('https://sheikhalamoud.org/apis/instructors').toPromise()
                : this.inInstructors;
            this.currentInstructors = this.instructors.filter(instructor => instructor['status'] === "current");
            this.currentInstructors.sort(function (a, b) {
                return a['order'] - b['order'];
            });
            this.pastInstructors = this.instructors.filter(instructor => instructor['status'] === "past");
...
let LearnComponent = class LearnComponent {
    constructor(http) {
        ...
        this.active = 0;
        this.cbGroupCoursesByDays = course => {
            if (!this.colorsSet)
                course.color = this.colors[Math.floor(Math.random() * 4)];
    ...
    getRwaq(id = "1") {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.halls = yield this.http.get('https://sheikhalamoud.org/apis/sessions/', { params: {
...
let SchedulesComponent = class SchedulesComponent {
    constructor(http) {
        ...
        this.colorsSet = false;
        this.filter = () => {
            this.days.map(day => day.courses = []);
            this.courses.map(this.cbGroupCoursesByDays);
            this.filtered = this.days[0].selected
                ? this.days.slice(1)
                : this.days.slice(1).filter(day => day.selected);
            if (this.selectedSystems.length && this.selectedSystems[0] != 0) {
                this.filtered.map(day => day.courses = day.courses.filter(course => this.selectedSystems.includes(course.System.uid)));
            }
            if (this.selectedLocations.length && this.selectedLocations[0] != 0) {
                this.filtered.map(day => day.courses = day.courses.filter(course => this.selectedLocations.includes(course.Location.uid)));
            }
        };
        this.cbGroupCoursesByDays = course => {
            if (!this.colorsSet)
    ...
    setFilters() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.days.map(day => {
                day.selected = this.selectedDays.includes(day.name);
            });
            if (!this.days.filter(loc => loc.selected).length)
                this.days[0].selected = true;
            this.locations = yield this.http.get('https://sheikhalamoud.org/apis/locations/').toPromise();
            this.locations.unshift({ name: 'all', uid: 0 });
            this.locations.map(location => {
                location.selected = this.selectedLocations.includes(location.uid);
            });
            if (!this.locations.filter(loc => loc.selected).length)
                this.locations[0].selected = true;
            this.systems = yield this.http.get('https://sheikhalamoud.org/apis/systems/').toPromise();
            this.systems.unshift({ name: 'all', uid: 0 });
            this.systems.map(system => {
                system.selected = this.selectedSystems.includes(system.uid);
            });
            if (!this.systems.filter(loc => loc.selected).length)
    ...
    getCourses() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.courses = yield this.http.get('https://sheikhalamoud.org/apis/sessions/', { params: {
    ...
    getEndDate() {
        ...
        m = m > 12 ? 1 : m;
        m = m > 9 ? m : "0" + m;
        const d = new Date(1, m, 0).getDate();
    ...
    toggle(variable, idx) {
        ...
        switch (variable) {
            case 0: // days
                ...
                selected = this.days.filter(day => day.selected);
                this.selectedDays = selected.map(day => day.name);
                localStorage.setItem('selectedDays', JSON.stringify(this.selectedDays));
                break;
            case 1: // systems
                this.handleSelectionUI(idx, this.systems, 'systems');
                selected = this.systems.filter(system => system.selected);
                this.selectedSystems = selected.map(system => system.uid);
            ...
            case 2: // locations
                ...
                selected = this.locations.filter(location => location.selected);
                this.selectedLocations = selected.map(location => location.uid);
    ...
    handleSelectionUI(idx, obj, lsv) {
        if (idx == 0 && !obj[0].selected) {
            obj.map(i => i.selected = false);
            if (lsv == 'days')
                this.selectedDays = [];
            else if (lsv == 'systems')
                this.selectedSystems = [];
        ...
        if (!obj.filter(i => i.selected).length) {
            obj[0].selected = true;
        }
    }
};
...
let SearchComponent = class SearchComponent {
    ...
    ngOnInit() {
        this.route.queryParams.subscribe(_ => this.remoteSearch());
    }
    remoteSearch() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.search = decodeURIComponent(location.hash.slice(16));
            const data = yield this.http.get(`https://sheikhalamoud.org/apis/search?query=${this.search}`).toPromise();
...
let SessionsComponent = class SessionsComponent {
    ...
    ngOnChanges(changes) {
        this.coursesNo = 0;
        changes.days.currentValue.map(day => this.coursesNo += day.courses.length);
    }
    getTimeFrom(d) {
        const date = new Date(d);
        let hours = date.getHours();
